...
| Niveau | IPS moyen public | n | IPS moyen privé sous contrat | n | Écart |
|---|---|---|---|---|---|
| Écoles | 74,6 | 32 | 97,4 | 9 | **+22,8** |
| Collèges | 69,6 | 7 | 95,9 | 5 | **+26,3** |
| Lycées — voie GT | 94,0 | 5 | 97,5 | 2 | +3,5 |
| Lycées — voie PRO | 72,7 | 4 | 90,1 | 3 | **+17,4** |

**Important — ne pas répéter l'erreur d'une moyenne « lycée » unique** : en mélangeant voie GT et voie PRO dans une moyenne globale, l'écart public/privé au lycée semble s'effondrer (à peine +4,6 points, calcul de brouillon écarté ici). En réalité, une fois les deux voies séparées, **l'avantage du privé reste fort dans les deux filières** — massif en PRO (+17,4, presque autant qu'au collège), plus modéré en GT (+3,5, sur seulement 5 établissements publics et 2 privés, échantillon très réduit). Ce qui brouillait le signal dans une moyenne globale : les lycées privés roubaisiens scolarisent proportionnellement plus d'élèves en voie pro (dont le niveau général est plus bas), ce qui tirait leur moyenne d'ensemble vers le bas et donnait une fausse impression de rapprochement avec le public. **Toujours comparer voie à voie, jamais un IPS « lycée » agrégé entre établissements de profils différents.**
...
**Fait notable :** contrairement à l'école et au collège, l'écart de la voie professionnelle à Roubaix avec l'académie est faible (80,2 vs 81,6, soit −1,4 point) — la voie pro roubaisienne n'est pas plus défavorisée que la moyenne régionale de la voie pro. C'est la voie GT qui creuse l'écart avec l'académie (95,0 vs 114,2, soit −19,2 points). Ce constat (comparaison Roubaix/académie, toutes filières confondues) est indépendant de celui d'ana_06 (écart public/privé, à l'intérieur même de Roubaix) : les deux se lisent séparément, ne pas les confondre dans la rédaction.
...
**§4 — L'avantage du privé, y compris en filière pro [ana_06]**
Montrer l'écart public/privé à chaque niveau — école (+23), collège (+26), lycée voie GT (+3,5, échantillon réduit) et voie PRO (+17,4). Le message : l'avantage du privé ne s'efface pas au lycée professionnel, contrairement à une lecture rapide en IPS « lycée » moyen — il faut juste comparer voie à voie pour le voir.
`[SUGGESTION VISUELLE : petit graphique à 4 paires de barres (école/collège/lycée GT/lycée PRO, public vs privé)]`
